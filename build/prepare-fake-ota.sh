...
DEVICE_GENERIC_URL='https://ci.ubports.com/job/Device%20Compatibility%20Images/job/halium-generic_arm64/lastSuccessfulBuild/artifact/halium_halium_arm64.tar.xz'
